...
$registro = '<!-- DATOS PERSONALES PERSONA -->
                ...
                <input type="hidden" name="usuario" id="usuario" value="companies">
                ...
                <input type="text" placeholder="Razón Social" name="nombreEmpresa" id="nombre1" class="mb-3 mt-2 w-75 border border-3 border-warning rounded-3 bg-black FontParrafo fs-5 text-center" required>
