...
<div class="w-25 d-none d-xl-flex bg-black rounded-3 border border-3 border-warning my-5 p-3 align-items-center flex-column" style="min-height: 470px;" >
    ...
    <p class="FontParrafo fs-6" >como empresa</p>
    ...
    <form action="" name="ingreso_xl" id="ingreso_xl" class="d-flex align-items-center flex-column w-75 my-5 text-center" >
        <input type="hidden" name="usuario_xl" id="usuario_xl" value="companies">
        ...
        <div class="d-flex w-100 justify-content-center">
            <button type="submit" onclick="idform(\'xl\')" id="btnIngreso_xl" class="border border-3 border-warning rounded-3 px-3 py-1 mt-2 mx-auto bg-black d-flex justify-content-center align-items-center"><span id="spinner_xl" class="spinner-border spinner-border-sm text-warning d-none"></span><span id="cargando_xl" class="FontAni fs-5 mx-2 d-none">Cargando . . .</span><span id="ingresar_xl" class="FontAni fs-5 mx-2">Ingresar</span></button>
        </div>
    </form>
</div>
...
<div class="w-50 d-none d-sm-flex d-xl-none bg-black rounded-3 border border-3 border-warning my-5 p-3 align-items-center flex-column" style="min-height: 470px;" >
    ...
    <form action="" name="ingreso_sm" id="ingreso_sm" class="d-flex align-items-center flex-column w-75 my-5" >
        <input type="hidden" name="usuario_sm" id="usuario_sm" value="companies">
        <label for="email"><span class="FontPrimary fs-5 ">Correo Electrónico</span></label>
        <input type="email" name="email" id="email_sm" placeholder="example@domain.com" class="my-3 w-75 border border-3 border-warning rounded-3 bg-black FontParrafo fs-5 text-center" >
...
<div class="w-75 d-flex d-sm-none bg-black rounded-3 border border-3 border-warning my-5 p-3 align-items-center flex-column" style="min-height: 470px;" >
    ...
    <form action="" name="ingreso_ep" id="ingreso_ep" class="d-flex align-items-center flex-column w-100 my-5" >
        <input type="hidden" name="usuario_ep" id="usuario_ep" value="companies">
        <label for="email"><span class="FontPrimary fs-6 " >Correo Electrónico</span></label>
        <input type="email" name="email" id="email_ep" placeholder="example@domain.com" class="my-3 w-75 border border-3 border-warning rounded-3 bg-black FontParrafo fs-5 text-center" >
