...
<header>
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav align-items-center me-md-5 d-none d-sm-flex">
                ...
                <li class="nav-item">
                    <button class="bg-black border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#menuUser">
                        <img src="./images/users/default.jpg" alt="acceso" class="rounded-circle border border-3 border-warning" style="width: 65px;" >
                    </button>
                </li>
            </ul>
            ...
            <div class="d-sm-none text-center">
                <button class="navbar-toggler ml-auto border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#menuSidebar">
                    <img src="./images/users/default.jpg" alt="acceso" class="rounded-circle border border-3 border-warning" style="width: 50px;" >
                </button>
    ...
    <?php 
        $currentUser;
        if($currentUser['client'] == 'persons'){
            $nombre = $currentUser['name_1']." ".$currentUser['name_2']." ".$currentUser['surname_1']." ".$currentUser['surname_2'];
        }else if($currentUser['client'] == 'companies'){
    ...
    <div class="offcanvas offcanvas-end bg-black w-sm-50 w-md-25 w-m border-3 border-start border-warning" id="menuUser"  style="overflow-y: scroll;">
        ...
        <div class="d-flex flex-column w-100 justify-content-center align-items-center">
            <div class="d-flex justify-content-center align-items-center border-img-b pb-5 w-100">
                <img src="./images/users/default.jpg" alt="acceso" class="rounded-circle border border-3 border-warning" style="width: 150px;" >
            </div>
            ...
            <div class="d-flex w-100 justify-content-center py-2 border-img-b"><button class="bg-black border-0"><span class="FontPrimary fs-5">Historial de pedidos</span></button></div>
            <div class="d-flex w-100 justify-content-center py-2 border-img-b"><button class="bg-black border-0"><span class="FontPrimary fs-5">Historial de Reservas</span></button></div>
            <div class="d-flex w-100 justify-content-center py-2 border-img-b"><button class="bg-black border-0"><span class="FontPrimary fs-5">Configuración</span></button></div>
